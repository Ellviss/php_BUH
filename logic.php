...
$result = mysqli_query(connect(), $query) or die(mysql_error()); // Отправляем переменную с запросом в базу данных 
...
$query = mysqli_query(connect(), "SELECT `id` FROM `users` WHERE `login` = '$login' AND `password` = '$password'"); // Формируем переменную с запросом к базе данных с проверкой пользователя
    ...
    else // Иначе если поля не пустые
{
	...
	$delresult = mysqli_query(connect(), $del_query) or die(mysql_error()); // Отправляем переменную с запросом в базу данных 
...
else // Иначе если поля не пустые
{
	...
	$addresult = mysqli_query(connect(), $add_query) or die(mysql_error()); // Отправляем переменную с запросом в базу данных 
